...
Функция СоздатьНовыйДокумент()
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьФункцию(УникальныйИдентификатор,"Обработки.ВКМ_МассовоеСозданиеАктов.СоздатьНовыйДокумент",ТабАкты, Организация, Дата);
...
//		НоваяРеализация.Организация = Объект.Организация;
//				
//		Попытка
...
//	КонецЦикла;
//	Сообщение = Новый СообщениеПользователю;
//	Сообщение.Текст = "Реализации сформированы";
//	Сообщение.Сообщить();
