...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//добавлен код 03.07.2025
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Специалист";
	ОписаниеПрофиля.Идентификатор = "97903ad5-978e-4c1c-b8e7-7762d65db9c5";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеОбслуживаниеКлиентовПрисоединенныеФайлы");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "bc8cb66b-a81a-41b2-96f1-7e7ffdffca14";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИзменениеДокументовОбслуживаниеКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПросмотрОбслуживаниеПрисоединенныеФайлы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленныеОбъекты");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "БухгалтерИТФирмы";
	ОписаниеПрофиля.Идентификатор = "33046b91-8a6a-4a91-88d5-6261050219df";
	...
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеВариантовОтчетов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументовРеализация");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетПоВыставленнымАктам");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленныеОбъекты");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "КадровикРасчетчик";
	ОписаниеПрофиля.Идентификатор = "911ad0e5-63c7-4306-bd2b-0256424429de";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетПоВыработкеСпециалистов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетЗарплатаОтпуска");
