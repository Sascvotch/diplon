...
Процедура СформироватьДвиженияПроцентОтвыполненныхРабот()
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ВКМ_ВыполненныеСотрудникомРаботыОстаткиИОбороты.Сотрудник,
...
Процедура РасчитатьДвиженияУдержания()
    ...
    |	ВКМ_Удержания.Подразделение КАК Подразделение,
    ...
    |////////////////////////////////////////////////////////////////////////////////
    |ВЫБРАТЬ
    |	ЕСТЬNULL(ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.СуммаБаза, 0) КАК СуммаДН,
    ...
    |		И ВТ_ОСновныеНачисления.Подразделение = ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.Подразделение
    |		И ВТ_ОСновныеНачисления.БазовыйПериодНачало = ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.БазовыйПериодНачало
    |		И ВТ_ОСновныеНачисления.БазовыйПериодКонец = ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.БазовыйПериодКонец";
