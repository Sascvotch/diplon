...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если КоличествоЧасовКОплате > 0 Тогда
		...
		Для Каждого ТекСтрокаВыполненныеРаботы Из ВыполненныеРаботы Цикл
			...
			Движение.СуммаКОплате = ТекСтрокаВыполненныеРаботы.ЧасыКОплатеКлиенту * Выборка.ВКМ_СтоимостьЧаса * ВыборкаПроцент.ПроцентОплаты / 100;
		КонецЦикла;
