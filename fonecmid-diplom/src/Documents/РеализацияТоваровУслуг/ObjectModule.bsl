...
//добавлено 03.10.2025
	...
	Отбор.Вставить("Номенклатура", Константы.ВКМ_НоменклатураРаботыСпециалиста.Получить());
	НайденноеЗначение = Услуги.НайтиСтроки(Отбор);

	Если НайденноеЗначение.Количество()>0 Тогда
		Движения.ВКМ_РеализацияРаботыНоменклатураСпециалиста.Записывать = Истина;
		Движения.ВКМ_РеализацияРаботыНоменклатураСпециалиста.Записать();
		Движение = Движения.ВКМ_РеализацияРаботыНоменклатураСпециалиста.Добавить();
		Движение.Период = Дата;
		Движение.ВидДвижения = ВидДвиженияНакопления.Приход;
		Движение.Клиент = Контрагент;
		Движение.Договор = Договор;
		Движение.Сумма = НайденноеЗначение[0].Сумма;
	КонецЕсли
//конец добавленного кода
КонецПроцедуры
